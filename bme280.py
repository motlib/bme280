...
class BME280(object):
    ...
    def __init__(self, bus, address=BME280_DEF_I2C_ADDR):
        '''Initialize and read the calibration data from the
        sensor.'''
    ...
    def _read_calibration_params(self):
        ...
        blk1 = self.bus.read_i2c_block_data(
            ...
            BME280_REG_CAL1,
            BME280_CAL1_LEN);
        dta1 = struct.unpack("<HhhHhhhhhhhhxB", bytearray(blk1))
        ...
        blk2 = self.bus.read_i2c_block_data(
            ...
            BME280_REG_CAL2,
            BME280_CAL2_LEN);
        dta2 = struct.unpack("<hBBBBB", bytearray(blk2))
        ...
        params = [
            ...
            dta2[0], 
            dta2[1],
            ((dta2[2] << 4) | (dta2[3] & 0x0F)),
            (((dta2[3] & 0xF0) << 12) | dta2[4]),
            dta2[5],
        ]

        cal = BME280CalParams._make(params)
